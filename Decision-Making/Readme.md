...
Diagnostic Analytics is used to examine trends in past data to identify possible root causes or relationships between variables.  It’s typically used after an event occurs to understand the reasons behind it. For example, investigating a drop in sales by analyzing data on customer behavior, marketing campaigns, and other factors to determine the root cause of the decline.
