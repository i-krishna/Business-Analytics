...
Although Tableau Public and certain enterprsie BI tools does not offer advanced interactive features such as linking and brushing or zoom and pan on high volume data for selecting and exporting specific data points, custom WebGL JavaScript scripts can be integrated to enable such interactive visual analytics techniques as mentioned in my thesis (Schulz et al., 2017). In the future, charts may not require manual brushing and linking. Instead, graph areas where the human eye focuses for more time could automatically export data for further analysis, adding a new layer to interactive visual analytics. 
